...
const routes: Routes = [
  { path: 'transacciones/incidencia-transito', redirectTo: '/transacciones/incidencia-transito/lista', pathMatch: 'full' },
  {
    path: 'transacciones/incidencia-transito',
    children: [
...
export class IncidenciasTransitoRoutingModule { }
