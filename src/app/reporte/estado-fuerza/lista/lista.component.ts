...
export class ReporteEstadoFuerzaComponent{
  ...
  public clues_estado_fuerza = JSON.parse(localStorage.getItem("clues"));
  //public fecha_actual = new Date();
  fecha_inicio: any = "2018-02-19 00:00";
  fecha_fin: any = "";
  clues: any = "";
  turno: any = "";
  busquedaActivada;
  ...
  //edo_incidencia: any [] = [];
  //colores_triage: any [] = []; moment().subtract(1, 'months').format('YYYY-MM-D h:mm');
  ...
  ngOnInit(){
    ...
    //console.log(moment().format('YYYY-MM-D h:mm'));
    this.fecha_fin = moment().format('YYYY-MM-D h:mm');
    
    //this.fecha_fin = moment().subtract(1, 'months').format('YYYY-MM-D h:mm');
    //Asignar el rango de fecha a 1 mes para realizar el filtrado de la busqueda de inicio.
    //this.fecha_inicio = moment().format('YYYY-MM-D h:mm');
    this.clues = this.clues_estado_fuerza;
  ...
  generate() {
    ...
    var res = doc.autoTableHtmlToJson(document.getElementById("datosReporte"));
      ...
      var pageContent = function (data) {
        ...
        doc.text("Reporte: Estados de Fuerza Ralizados", data.settings.margin.left + 90, 9);
        doc.setFontSize(8)
      ...
      doc.save('Reporte Estado de Fuerza.pdf');
