...
export class ListaComponent {
  ...
  //         console.log("todo el dato", resultado);
  ...
  //         var num = resultado.data.referencias.length;

  //         var columns_referencias = [
  //           {title: "N° Seguimiento", dataKey: "numero"},
  //           {title: "Unidad de Origen", dataKey: "clues_origen"},
  //           {title: "Unidad de Destino", dataKey: "clues_destino"},
  //           {title: "Diagnostico", dataKey: "diagnostico"},
  //           {title: "Resumen Clinico", dataKey: "resumen_clinico"},              
  //         ];

  
  //         var rows_referencias = [];
        
  //         resultado.data.referencias.forEach(element => {


  //           rows_referencias.push({
  //               "numero": num --,
  //               "clues_origen": element.clues_origen_o,
  //               "clues_destino": element.clues_destino_o,
  //               "diagnostico": element.diagnostico,
  //               "resumen_clinico": element.diagnostico,
  //               "cie10_movimientos": element.subcategorias_cie10?element.subcategorias_cie10.nombre:'',
  //             });;
            
  //         });

  //         console.log("el array de referencias",rows_referencias);
