...
export class ReporteEstadoFuerzaComponent{
  ...
  */
  generate() {
    ...
    var clue = this.clues_estado_fuerza;
    ...
    var res = doc.autoTableHtmlToJson(document.getElementById("datosReporte"));
      ...
      var pageContent = function (data) {
        ...
        doc.text("Reporte: Estados de Fuerza Ralizados", data.settings.margin.left + 70, 9);
        doc.setFontSize(8)
      ...
      doc.save('Reporte Estado de Fuerza'+' '+fecha_actual);
