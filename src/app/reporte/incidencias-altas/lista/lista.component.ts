...
*/
@Component({
  selector: 'reporte-incidencia-altas',
...
*/
export class ReporteAltaComponent{
  ...
  * @type {object}
  */
  public altasClue = JSON.parse(localStorage.getItem("clues"));
  ...
  */
  ...
  /**
  * contiene la informacion de
  * la unidad medica temporal.
  * @type {any}
  */
  clues_temp: any = "";

  /**
  * contiene el tipo de alta
  * @type {any}
  */
  tipo_alta: any = "";

  /**
  * contiene el metodo de planificacion
  * del catalogo
  * @type {any}
  */
  ...
  */
  ...
  /**
  * Variable que conecta con la URL de la API, para traer las unidades medicas en un Autocomplet que tiene la Vista.
  * @type {string}
  */
  ...
  */
  lista_altas(url, e){
    ...
    this.listar('reportes/incidencias-altas?fecha_inicio='+this.fecha_inicio+'&fecha_fin='+
    this.fecha_fin+'&clues='+this.clues+'&tipo_alta='+this.tipo_alta+'&metodos_planificacion='+this.me_planificacion+'&turno='+this.turno
    );
    //referencia
  ...
  */
  generate() {
      ...
      var pageContent = function (data) {
        ...
        doc.text("Reporte de Altas", data.settings.margin.left + 117, 9);
        doc.setFontSize(8)
      ...
      doc.save('Reporte de Altas'+' '+fecha_actual);
